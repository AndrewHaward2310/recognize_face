...
class Ui_RegisterWindow(object):
    def setupUi(self, RegisterWindow, callback=None):
        ...
        self.nameLog.setGeometry(QtCore.QRect(210, 39, 241, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 110, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.sexBog = QtWidgets.QComboBox(parent=self.centralwidget)
        self.sexBog.setGeometry(QtCore.QRect(210, 110, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.registerBtn.setGeometry(QtCore.QRect(170, 250, 181, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(70, 180, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.sexBog_2 = QtWidgets.QComboBox(parent=self.centralwidget)
        self.sexBog_2.setGeometry(QtCore.QRect(210, 180, 111, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.sexBog_2.setFont(font)
        self.sexBog_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.sexBog_2.setObjectName("sexBog_2")
        self.sexBog_2.addItem("")
        self.sexBog_2.addItem("")
    ...
    def retranslateUi(self, RegisterWindow):
        ...
        self.label_3.setText(_translate("RegisterWindow", "ĐỐI TƯỢNG"))
        self.sexBog_2.setItemText(0, _translate("RegisterWindow", "USER"))
        self.sexBog_2.setItemText(1, _translate("RegisterWindow", "ENEMY"))
    
    def handleRegister(self, callback):
        name = self.nameLog.text()
        sex = self.sexBog.currentText()
        register_time = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        type_user = self.sexBog_2.currentText()

        # Save to users.xlsx
        new_data = pd.DataFrame([[name, sex, register_time, type_user]], columns=["Name", "Sex", "RegisterTime", "Type"])
